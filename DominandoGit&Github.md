...
2. <code>git add .</code>  o  <code>git add README.md</code>    -> Seleccionas los cambios (Puedes seleccionar todos los cambios o algo en específico).
3. <code>git commit -m "Texto descriptivo"</code> -> Guardas tu cambio.
4. <code>git push</code> -> Subes el cambio a la nube de Github.
